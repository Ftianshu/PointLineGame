...
namespace Survival.Editor
{
    ...
    {
        private const string DataTablePath = "DataTables";
        private const string CSharpCodePath = "Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Configs/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "Survival");
